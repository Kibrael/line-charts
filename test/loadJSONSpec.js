...
describe('load json', function() {
  ...
  beforeEach(function() {
    ...
    getJSON('data/bank/type/al/data.json', callback);
    request = jasmine.Ajax.requests.mostRecent();
    expect(request.url).toBe('data/bank/type/al/data.json');
    expect(request.method).toBe('GET');
  });

  it('should load json', function() {
    request.respondWith(JSON.parse(response));
